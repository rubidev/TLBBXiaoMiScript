...
function 晴天精通属性升级(装备位置名称,属性,等级)
...
function  晴天全自动精通属性升级(index)
屏幕提示("晴天全自动精通属性升级:  "..index)
屏幕提示("晴天全自动精通属性升级:  "..index)
屏幕提示("晴天全自动精通属性升级:  "..index)
取出物品("精金石")
...
晴天精通属性升级("腰带","体力",index)
晴天精通属性升级("护肩","体力",index)
晴天精通属性升级("手套","体力",index)
晴天精通属性升级("鞋子","体力",index)
晴天精通属性升级("帽子","体力",index)
晴天精通属性升级("衣服","体力",index)

--晴天精通属性升级("左护符",属性攻击,index)
--晴天精通属性升级("右护符",属性攻击,index)
--晴天精通属性升级("左戒指",属性攻击,index)
--晴天精通属性升级("右戒指",属性攻击,index)
--晴天精通属性升级("护腕",属性攻击,index)
--晴天精通属性升级("项链",属性攻击,index)
else 
