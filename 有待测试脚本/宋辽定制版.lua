...
function StartSongLiao()
    ...
    if ZhengRong == "157" then
        -- 角色为辽方阵营，进攻宋方
        if menPai == "少林" or menPai == "丐帮" or menPai == "慕容" or menPai == "天山" or menPai == "明教" then
            FangYuTaINFO = {
            ...
            FangYuTaINFO = {
                { name = "#{SLDZ_220216_168}", x = 108, y = 230 }, -- 宋的防御塔·一
                { name = "#{SLDZ_220216_167}", x = 160, y = 219 }, -- 宋的防御塔·二
                { name = "#{SLDZ_220216_169}", x = 186, y = 230 }, -- 宋的防御塔·三
                { name = "#{SLDZ_220216_162}", x = 186, y = 230 }, -- 宋的四象塔
                { name = "#{SLDZ_220216_163}", x = 204, y = 254 }, -- 宋的四象塔
                { name = "#{SLDZ_220216_161}", x = 118, y = 255 }, -- 宋的四象塔
                { name = "#{SLDZ_220216_164}", x = 117, y = 258 }, -- 宋的四象塔
                { name = "#{SLDZ_220216_165}", x = 159, y = 274 }, -- 宋帅
            }
        end
    else
        -- 角色为宋方阵营，进攻辽方
        if menPai == "少林" or menPai == "丐帮" or menPai == "慕容" or menPai == "天山" or menPai == "明教" then
            ...
            FangYuTaINFO = {
                { name = "#{SLDZ_220216_172}", x = 212, y = 91 },  -- 辽的防御塔·一
                { name = "#{SLDZ_220216_170}", x = 160, y = 96 },  -- 辽的防御塔·二
                { name = "#{SLDZ_220216_171}", x = 120, y = 88 },  -- 辽的防御塔·三
                { name = "#{SLDZ_220216_161}", x = 120, y = 88 },  -- 辽的四象塔
                { name = "#{SLDZ_220216_164}", x = 118, y = 58 },  -- 辽的四象塔
                { name = "#{SLDZ_220216_162}", x = 188, y = 63 },  -- 辽的四象塔
                { name = "#{SLDZ_220216_163}", x = 198, y = 53 },  -- 辽的四象塔
                { name = "#{SLDZ_220216_166}", x = 159, y = 38 },  -- 辽将
            }
        end
    end
